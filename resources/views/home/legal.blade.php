  ...
  <div class="col mx-0 px-0">
    <div class="yy-legal">
      ...
      <ol>
        ...
        <li>「当社」とは、 ハマダエンタープライズ株式会社を意味します。</li>
        <li>「当社ウェブサイト」とは、そのドメインが「yyux.jp」である、当社が運営するウェブサイト（理由の如何を問わず、当社のウェブサイトのドメインまたは内容が変更された場合は、当該変更後のウェブサイトを含みます。）を意味します。</li>
        <li>「登録ユーザー」とは、第3条に基づいて本サービスの利用者としての登録がなされた個人または法人を意味します。</li>
        <li>「本サービス」とは、当社が提供するyyuxという名称のサービス（理由の如何を問わずサービスの名称または内容が変更された場合は、当該変更後のサービスを含みます。）及びそれに関連するサービスの総称を意味します。</li>
        <li>「利用者」とは、本サービスを利用する全ての方を意味します。</li>
      </ol>
      ...
      <ol>
        ...
        <li>当社は、当社の基準に従って、前項に基づいて登録申請を行った登録希望者（以下「登録申請者」といいます。）の登録の可否を判断し、当社が登録を認める場合にはその旨を登録申請者に通知します。登録申請者の登録ユーザーとしての登録は、当社が本項の通知を行ったことをもって完了したものとします。</li>
      ...
      <h2>第4条（登録事項の正確性）</h2>
      <ol>
        <li>登録ユーザーは、当社に対し、個人情報を不備・齟齬のないよう正確に提供するものとします。登録ユーザーが提供した個人情報が正確でなかったこと、および、その内容の不備・齟齬などに起因して第三者から何らかの意義、請求もしくは要求などがなされた場合には、自己の費用負担と責任で対処するものとし、当社に一切の迷惑をかけないことを保証するものとします。</li>
      ...
      <h2>第6条（サービスの提供）</h2>
      <ol>
        <li>本サービスは、登録ユーザー間における質問回答形式による情報交換、利用者における情報収集および情報閲覧の機会、ならびにそれらの環境を提供することを目的とします。</li>
        <li>当社は登録ユーザーに事前告知することなく、本サービスに新しいサービスを追加、または変更することができるものとします。</li>
        <li>本サービスは、複数の他のウェブサイトのサービスと連携しており、本サイト上にて投稿された内容は、一定条件の下、他のウェブサイトにも公開されます。</li>
      </ol>
      ...
      <ol>
        ...
        <li>当社、本サービスの他の登録ユーザーまたはその他の第三者に対する詐欺または脅迫行為</li>
        <li>公序良俗に反する行為</li>
        <li>当社、本サービスの他の登録ユーザーまたはその他の第三者の知的財産権、肖像権、プライバシーの権利、名誉、その他の権利または利益を侵害する行為</li>
        <li>
          本サービスを通じ、以下に該当し、または該当すると当社が判断する情報を当社または本サービスの他の登録ユーザーに送信する行為
          <ul>
        ...
        <li>第三者に成りすます行為</li>
        <li>ユーザーIDを他者と共有する行為</li>
        <li>複数のユーザーIDを1人で保有する行為</li>
        <li>本サービスの他の登録ユーザーのIDまたはパスワードを利用する行為</li>
        <li>当社が事前に許諾しない本サービス上での宣伝、広告、勧誘、または営業行為</li>
        <li>本サービスの他の利用者の情報の収集を目的とした行為</li>
        <li>当社、本サービスの他の登録ユーザーまたはその他の第三者に不利益、損害、不快感を与える行為</li>
        <li>当社ウェブサイト上で掲載する本<a href="#">サービス利用に関するルール</a>に抵触する行為</li>
        <li>反社会的勢力等への利益供与</li>
        <li>面識のない異性との出会いを目的とした行為</li>
        <li>前各号の行為を直接または間接に惹起し、または容易にする行為</li>
        <li>本サービスを利用することにより知り得たサイト運営上の情報や技術情報等をもとに、本サービスと同様のサービスを提供する行為</li>
      ...
      <ol>
        ...
        <li>登録ユーザーは、投稿データについて、当社に対し、世界的、非独占的、無償、サブライセンス可能かつ譲渡可能な使用、複製、編集、改編、掲載、転載、公衆送信、上映、展示、提供、販売、譲渡、貸与、翻訳、翻案、配布などができる権利および二次的著作物に関する現著作権者の権利（著作権法２１条ないし２８条の権利をいい、商用利用を含む）に関するライセンスを付与します。</li>
        <li>登録ユーザーは、サイトの質向上・宣伝・利用促進のため、他利用者による投稿内容の編集、メタデータなどへの配信、当社サイト内での掲載、当社が提携しているサイトへの掲載、などを許可するものとします。</li>
      ...
      <ol>
        ...
        <li>退会後の個人情報の取り扱いについては、第17条の規定に従うものとします。 </li>
      </ol>
      ...
      <ol>
        ...
        <li>当社は、利用者が本サービスから得た情報（本サービスに記載されている情報、紹介されている書籍などの外部の情報、リンク先の情報を含む）による一切の行為またはその結果について、一切の責任を負わないものとします。</li>
        <li>当社は、リンクを通じて利用者がアクセスするウェブサイトについて、いかなる責任も負いません、リンクされていることは、リンク先と当社が関連会社、取引先などの関係を有していることを意味しません。</li>
      </ol>
      ...
      <ol>
        ...
        <li>当社は、本サービス内での投稿データについて、管理義務、削除義務は負わないものとします。</li>
      ...
      <h2>第17条（個人情報の取り扱い）</h2>
      <p>当社による登録ユーザーの個人情報の取り扱いについては、「<a href="/privacy">個人情報の取り扱い</a>」の定めによるものとし、登録ユーザーはこの「個人情報の取り扱い」に従って当社が登録ユーザーの個人情報を取り扱うことについて同意するものとします。</p>
      ...
      <ol>
        ...
        <li>本規約またはサービス利用契約に起因し、または関連する一切の紛争については、東京地方裁判所または東京簡易裁判所を第一審の専属的合意管轄裁判所とします。</li>
      </ol>
    </div>
  </div>
@endsection
