  ...
  <div class="col mx-0 px-0">
    <div class="yy-about">
      ...
      <div class="mt-5">
        ...
        <p>yyUXでは<span class="yy-emphasis">レビュー</span>と<span class="yy-emphasis">レビュー依頼機能</span>を用意してあります。世の中のありとあらゆるUXについてレビューし、そしてレビューしてもらいましょう！UXについてyy（ワイワイ）議論しましょう！</p>
      </div>
      ...
      <div class="mt-5">
        ...
        <p>ただ、単に何が悪いのかを提示するだけでは、改善に活かしきれません。どうすれば良くなるか？に焦点をあててレビューしましょう。</p>
        <h3 class="good_ux">OPINION UX</h3>
        <p>「OPINION UX」は良いか悪いか意見が別れるUXについてのレビューです。</p>
        <p>どこが良いと思うのか悪いと思うのか、どこが評価の分かれる点なのか明確にして意見を述べてみましょう。</p>
      </div>
      ...
      <div class="mt-5">
        <h2>レビュアーをフォローしよう！</h2>
        <p>yyUXではレビュアーをフォローできます。yyUX内ではスコア機能があります。スコアが高ければ高いほどUXに対する関心度が高く、周りの評価も高いという意味になります。</p>
        <p>レビュー・コメントに対して正しい評価をしていくことだけでもより良いUXにつながっていきます。</p>
