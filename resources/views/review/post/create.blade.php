    ...
    <div class="col mx-3">
        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/post/store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label for="title" class="col-2 col-form-label">タイトル<span class="yy-post-annotation"> ※必須</span></label>
            ...
            <div class="form-group row">
                <label class="col-2 col-form-label" style="line-height: 1;">UXタイプ <br><a class="yy-post-annotation" href="/about#aboutyyux" target="_blank">※UXタイプとは</a></label>
                <div class="col-10 form-check col-form-label">
            ...
            <label class="col-12 col-form-label p-0">レビュー参考画像</label>
